(ns haip.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [haip.routes.services :refer [service-routes]]
            [haip.middleware :as middleware]
            [haip.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "haip is shutting down...")
  (stop-nrepl)
